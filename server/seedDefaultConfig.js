...
async function seedDefaultConfig() {
  try {
    ...
    const defaultConfig = new SiteConfig({
      ...
      bootcampDetails: [
        { icon: 'book', title: 'Comprehensive Curriculum', description: 'HTML, CSS, JavaScript, React, Node.js, MongoDB - everything you need', color: 'from-code-green to-emerald-500', order: 0, visible: true },
        { icon: 'lightning', title: 'Fast-Paced Learning', description: 'Intensive hands-on sessions designed to maximize your learning', color: 'from-code-blue to-cyan-500', order: 1, visible: true },
        { icon: 'tools', title: 'Build Real Projects', description: 'Create portfolio-worthy projects from day one', color: 'from-code-purple to-pink-500', order: 2, visible: true },
        { icon: 'teacher', title: 'Expert Mentorship', description: 'Learn from experienced developers and industry professionals', color: 'from-code-yellow to-orange-500', order: 3, visible: true }
      ],
      ...
      bonusBenefits: [
        { icon: 'certificate', title: 'Certificate of Completion', description: 'Get certified upon successful completion', color: 'from-blue-500 to-purple-500', order: 0, visible: true },
        { icon: 'users', title: 'Community Access', description: 'Join our exclusive developer community', color: 'from-green-500 to-teal-500', order: 1, visible: true },
        { icon: 'book', title: 'Learning Resources', description: 'Access to curated learning materials', color: 'from-orange-500 to-red-500', order: 2, visible: true },
        { icon: 'gift', title: 'Swag & Goodies', description: 'Exclusive Aarambh merchandise for participants', color: 'from-pink-500 to-purple-500', order: 3, visible: true }
      ],

      contactInfo: {
        email: 'aarambh@college.edu',
        location: 'College Campus, India',
        socialLinks: {
          github: 'https://github.com/aarambh',
          linkedin: 'https://linkedin.com/company/aarambh',
          twitter: 'https://twitter.com/aarambh',
          discord: 'https://discord.gg/aarambh'
        }
      }
    });
    ...
    console.log('\n📋 Summary:');
    console.log(`- Form Fields: ${defaultConfig.formFields.length}`);
    console.log(`- Schedule Items: ${defaultConfig.schedule.length}`);
    console.log(`- Curriculum Modules: ${defaultConfig.curriculum.length}`);
    console.log(`- Bootcamp Details: ${defaultConfig.bootcampDetails.length}`);
    console.log(`- Bonus Benefits: ${defaultConfig.bonusBenefits.length}`);
